...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h5 class="bg-success text-white rounded p-2 border-dark border">Gerencie a sua propriedade:</h5>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="card-header bg-success text-white border border-dark">Gestão dos lotes</div>
                ...
                <div class="col">
                    <div class="card-header bg-success text-white border border-dark">Gerenciar Estoque</div>
                    <div class="card-body border border-dark">
                ...
                <div class="col">
                    <div class="card-header bg-success text-white border border-dark">Situação Financeiro</div>
                    <div class="card-body border border-dark">
